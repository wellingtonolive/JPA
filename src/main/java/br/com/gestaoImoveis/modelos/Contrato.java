...
public class Contrato {
	...
	public Contrato(Integer numeroContrato, Date dtEmissao, Date dtValidade, Imoveis imovel, Pessoas proprietario,
			Pessoas inquilino, BigDecimal valorAluguel, BigDecimal valorDeposito) {
